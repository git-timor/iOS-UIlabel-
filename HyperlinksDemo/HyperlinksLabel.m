...
//  RAJ
//
//  Created by 周周旗 on 2018/3/30.
//  Copyright © 2018年 周旗. All rights reserved.
//
...
- (void)urlValidation:(NSString *)string {
    ...
    for (int i = 0; i<urlStrs.count; i++) {
        ...
        self.selectionHandler = ^(NSRange range, NSString *string){
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"LinkAccess" object:nil userInfo:dic];
        };
    }
}
